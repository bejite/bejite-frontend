...
export default function PitchVideoPlayer({
  ...
  return (
    <div className="relative w-full max-w-[260px] xs:max-w-[280px] sm:max-w-[320px] md:max-w-[340px] lg:max-w-[360px] aspect-[9/16] bg-black rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl border border-gray-800 shrink-0 flex items-center justify-center group select-none mx-auto lg:mx-0">
      <video
        ref={videoRef}
        src={pitch.videoUrl}
      ...
      <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-3 sm:p-4 z-20 flex flex-col gap-1.5 sm:gap-2">
        <div
